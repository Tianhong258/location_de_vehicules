...
//        //Mockito.when(daoMock.findByEmail("tanya@gmail.com")).thenReturn(Optional.of(creerClient()));
//        EntityNotFoundException ex = assertThrows(EntityNotFoundException.class, () -> service.trouver("tanya@gmail.com", "33Tanya@"));
//        assertEquals("Saisie de mot de passe est incorrecte", ex.getMessage());
//    }
//
//    @DisplayName("""
//            Test de la méthode verifierEtTrouver(ok) qui doit renvoyer un ClientResponseDto
