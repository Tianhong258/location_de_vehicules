...
public record AdminRequestDto (
        @Schema(description = "Nom de l'administrateur", example = "Lepetit")
        @NotBlank(message = "Le nom est obligatoire")
        @Size(min = 3, max = 20, message = "Le nom doit être entre 3 et 20 caractères")
        String nom,

        @Schema(description = "Prénom de l'administrateur", example = "Jean-Michel")
        @NotBlank(message = "Le prénom est obligatoire")
        @Size(min = 3, max = 20, message = "Le prénom doit être entre 3 et 20 caractères")
        String prenom,

        @Schema(description = "Email de l'administrateur", example = "JMAdmin@gmail.com")
        @NotNull(message = "L'email est obligatoire")
        @Email(message = "Le format du mail est invalide")
        String email,

        @Schema(description = "Mot de passe de l'administrateur", example = "345JMAdmin@")
